...
<p style="color:red">${msg }</p>
				<spring:url value="/academicdates/save" var="formUrl"/>
						<form class="form-horizontal form-label-left input_mask" method="post"' action="${formUrl }" >
					<div class="form-group">
						
					<div class="form-group">
						<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
						<a class="btn btn-info" href="<spring:url value="/academicdates/"/>">Back</a>
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<input type="text"
									class="form-control " name="academicdate" value="">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<input type="text"
									class="form-control " name="academicdateen" value="">
						</div>
					</div>
			</form>
	<tag:footer/>
