	...
	<div class="container">
		<div class="card card-container">
			...
			<img id="profile-img4" class="profile-img-card"
				src="template/images/shramjyoti1.jpg" />
			...
			<form class="form-signin" method="post" action="login">
				<span id="reauth-email" class="reauth-email"></span> <input
					type="password" id="inputPassword1" name="staffCode"
					class="form-control" placeholder="Staff Code" required autofocus>
				<!-- <input type="email" id="inputEmail" class="form-control" placeholder="User Name" required autofocus> -->
				<input type="password" id="inputPassword2" name="username"
