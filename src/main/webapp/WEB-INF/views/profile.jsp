				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
								<img src="//124.41.193.91/projectdatas/${sessionScope.foldername }/images/logo.jpg" alt="..."
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> Student <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="nav/studentAdmission" target="iframe_a">New
												Student</a></li>
										<li><a href="nav/listStudents" target="iframe_a">Students
												List</a></li>
								...
								<li><a><i class="fa fa-edit"></i> Staff <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="nav/newStaff" target="iframe_a">New
												Staff </a></li>
										<li><a href="nav/staffList" target="iframe_a">Staff
												List</a></li>
									</ul></li>
								<li><a><i class="fa fa-edit"></i> Exam <span
									...
									<ul class="nav child_menu">
										<li><a><i class="fa fa-edit"></i> Create<span
												class="fa fa-chevron-down"></span></a>
											<ul class="nav child_menu">
												<li><a href="nav/createExam" target="iframe_a">Create
														Exam</a></li>
												<li><a href="nav/createMarksReport" target="iframe_a">Create
														Marks Report</a></li>
												<li><a href="nav/createReportonSubject"
													target="iframe_a">Create Marks Subject Teacher</a></li>
											</ul></li>
										<li><a><i class="fa fa-edit"></i> Result<span
												class="fa fa-chevron-down"></span></a>
											<ul class="nav child_menu">
												<li><a href="nav/bulkGradeReportSearch"
													target="iframe_a">Grade Sheet</a></li>
												<li><a href="nav/bulkReportSearch" target="iframe_a">Marks
														Sheet</a></li>
												<li><a href="nav/marksReportSearch" target="iframe_a">Search
														Report</a>
											</ul></li></li>
							</ul>
							</li>
							<li><a><span class="fa fa-chevron-down"></span><i
								...
								<ul class="nav child_menu">
									...
									<li id="i"><a href="nav/financialAccount"
										target="iframe_a">Open Financial Account</a></li>

									<li><a href="pageNotFound.jsp" target="iframe_a">Open
							...
							<li id="i"><a href="nav/viewTrialBalance" target="iframe_a">Trial
									Balance </a></li>
							<li id="i"><a href="nav/viewTrialBalanceSummary"
								target="iframe_a">Trial Balance Summary </a></li>
							<li id="i"><a href="nav/viewAccount" target="iframe_a">Statements
							</a></li>
							<li><a><span class="fa fa-chevron-down"></span>Invoice</a>
								<ul class="nav child_menu">
									<li id="a"><a href="invoice/search" target="iframe_a">
											Invoice </a></li>
									<li id="a"><a href="claimbill/studentList"
										target="iframe_a"> Claim Bill </a></li>
									<li id="a"><a href="nav/viewBulkClaimBill"
										target="iframe_a"> Class Claim Bill </a></li>
									<li id="a"><a href="nav/viewClaimBill" target="iframe_a">
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-sitemap"></i> Settings <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="nav/generalSettings" target="iframe_a">Office
												Settings</a>
										...
										<li><a>Account Settings<span
											...
											<ul class="nav child_menu">
												...
												<li><a href="nav/accountType" target="iframe_a">Account
														Type</a></li>
												<li><a href="nav/feeSetting" target="iframe_a">Fee
														Setting</a></li>
												<li><a href="nav/viewFeeHead" target="iframe_a">Fee
														Head</a>
												<li><a href="nav/viewFeeStructure" target="iframe_a">Fee
														Structure</a>
											</ul></li>
										<li><a href="nav/initialDetails" target="iframe_a">Basic
												Details</a>
										<li><a href="nav/attendance" target="iframe_a">Exam
												Attendance</a>
										<li><a
