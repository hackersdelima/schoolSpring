					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
								...
								<li><a><i class="fa fa-edit"></i> Student <span
									...
									<ul class="nav child_menu">
										<li><a href="<spring:url value="/nav/studentAdmission"/>" >New
												Student</a></li>
										<li><a href="<spring:url value="/nav/listStudents"/>" >Students
												List</a></li>
										...
										<li><a><i class="fa fa-edit"></i> Create<span
											...
											<ul class="nav child_menu">
												<li><a href="<spring:url value="/nav/createExam"/>" >Create
														Exam</a></li>
												<li><a href="<spring:url value="/nav/createMarksReport"/>" >Create
														Marks Report</a></li>
												<li><a href="<spring:url value="/nav/createReportonSubject"/>"
													>Create Marks Subject Teacher</a></li>
											</ul></li>
										<li><a><i class="fa fa-edit"></i> Result<span
											...
											<ul class="nav child_menu">
												<li><a href="<spring:url value="/nav/bulkGradeReportSearch"/>"
													>Grade Sheet</a></li>
												<li><a href="<spring:url value="/nav/bulkReportSearch"/>" >Marks
														Sheet</a></li>
												<li><a href="<spring:url value="/nav/marksReportSearch"/>" >Search
														Report</a>
											</ul></li></li>
							</ul>
							</li>
							<li><a><span class="fa fa-chevron-down"></span><i
								...
								<ul class="nav child_menu">
									...
									<li id="i"><a href="<spring:url value="/nav/financialAccount"/>"
										>Open Financial Account</a></li>

									<li><a href="<spring:url value="/nav/pageNotFound"/>" >Open
											New Shareholder Account</a> <li id="v"><a href="<spring:url value="/nav/viewAccount"/>" >Amendment
											of Account</a></li>
									...
									<li><a><span class="fa fa-chevron-down"></span>Payment
										...
										<ul class="nav child_menu">
											<li><a href="<spring:url value="/nav/paymentVoucher"/>" >
													Create</a></li>
											<li><a href="<spring:url value="/nav/viewPaymentVoucher"/>" >
													View</a></li>
										</ul></li>
								</ul></li>
							<li><a><i class="fa fa-tasks"
								...
								<ul class="nav child_menu">
									<li id="i"><a href="<spring:url value="/nav/viewTrialBalance"/>" >Trial
									Balance </a></li>
							<li id="i"><a href="<spring:url value="/nav/viewTrialBalanceSummary"/>"
								>Trial Balance Summary </a></li>
							<li id="i"><a href="<spring:url value="/nav/viewAccount"/>" >Statements
							</a></li>
								</ul></li>
							<li><a><i class="fa fa-tasks"
									...
									<ul class="nav child_menu">
										...
										<li><a>Subject Settings<span
											...
											<ul class="nav child_menu">
												...
												<li><a href="<spring:url value="/nav/assignSubjects"/>" >Assign
														Subjects</a></li>
												<li><a href="<spring:url value="/nav/assignedsubjects"/>" >Assigned
														Subjects List</a></li>
											</ul></li>
										<li><a>Account Settings<span
											...
											<ul class="nav child_menu">
												...
												<li><a href="<spring:url value="/nav/viewFeeStructure"/>" >Fee
														Structure</a>
										...
										<li><a
											...
											>Student Attendance</a></li>
												<li><a href="<spring:url value="/nav/promotion"/>" >Student Promotion</a>
